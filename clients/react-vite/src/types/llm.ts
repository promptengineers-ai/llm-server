...
export const modelLabels: { [key in ModelType]: string } = {
    [ModelType.AZURE_GPT_4_OMNI]: "Azure / GPT-4o",
    [ModelType.AZURE_TEXT_EMBED_3_LARGE]: "Azure / Text Embed 3 Large",
    ...
    [ModelType.OPENAI_GPT_4_OMNI]: "OpenAI / GPT-4o",
    ...
    [ModelType.GROQ_LLAMA_3_1_70B]: "Groq / LLaMA 3.1 70B",
    [ModelType.GROQ_LLAMA_3_1_405B]: "Groq / LLaMA 3.1 405B",
    [ModelType.ANTHROPIC_HAIKU]: "Claude 3 / Haiku",
    [ModelType.ANTHROPIC_OPUS]: "Claude 3 / Opus",
    [ModelType.ANTHROPIC_SONNET]: "Claude 3.5 / Sonnet",
};
...
export const multiModalModels = {
    [ModelType.AZURE_GPT_4_OMNI]: "Azure - GPT-4 Omni",
    [ModelType.OLLAMA_LLAVA]: "Ollama - LLaVA",
    [ModelType.OLLAMA_BAKLLAVA]: "Ollama - BakLLaVA",
...
export enum EmbeddingModel {
    AZURE_TEXT_EMBED_3_LARGE = ModelType.AZURE_TEXT_EMBED_3_LARGE,
